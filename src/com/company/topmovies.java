...
public class topmovies extends actualpage {
    ...
    public void get_movies(String username){
        ...
        try {
            ...
            //Using the DBTable class we print the "Top Movies" data base as a whole table
            DBTablePrinter.printTable(con, "users.topmovies");
            ...
            switch (select_movie){
                case 1:
                    ...
                    //Confirm the selection of the user to avoid accidents
