...
public class foradults extends actualpage {
    ...
    public void get_movies(String username){
        ...
        try {
            ...
            //Using the DBTable class we print the "For adults" data base as a whole table
            net.efabrika.util.DBTablePrinter DBTablePrinter = null;
            DBTablePrinter.printTable(con, "users.foradults");
